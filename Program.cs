...
Console.WriteLine("Hi, I'm Angel!");
...
string[] names2 = new[] { "Alex", "Maria", "Rachel", "Luna" };
...
{
  { "Apple", "Banana", "Garry", "Dino" },
  { "Perry", "Barry", "Choco", "Dan" },
  { "Girrafe", "Fish", "Cat", "Rhino" }
};
...
grid2[0, 0] = "Apple"; // assign string values
// and so on
grid2[2, 3] = "Rhino";

string[][] jagged = new[] // array of string arrays
{
  new[] { "Apple", "Banana", "Garry" },
  new[] { "Perry", "Barry", "Choco", "Dan" },
  new[] { "Girrafe", "Fish" }
};
